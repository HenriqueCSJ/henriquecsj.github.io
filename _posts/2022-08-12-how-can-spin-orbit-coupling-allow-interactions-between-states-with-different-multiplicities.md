...
Each spin part has a well-defined value of $S$, and each orbital part $\left | \phi_{orbital} \right >$ has a well-defined value of $L$. So the total state $\left | \psi \right >$ has well-defined values of both $S$ and $L$.